...
public class PieceWorkerEmployee2 {
    ...
    public PieceWorkerEmployee2(int empID, String name, float totalPiecesFinished, double ratePerPiece, int dateHired, int birthDate) {
        this.empID = empID;
        Name = name;
    ...
    public PieceWorkerEmployee2(int empID, String name, int birthDate, int dateHired) {
        this.empID = empID;
        Name = name;
        this.birthDate = birthDate;
        this.dateHired = dateHired;
