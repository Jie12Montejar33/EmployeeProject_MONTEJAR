...
public class BasePlusCommisonEmployee2 {
    ...
    public BasePlusCommisonEmployee2(int empID, String name, int dateHired, int birthDate) {
        this.empID = empID;
        Name = name;
    ...
    public BasePlusCommisonEmployee2(int empID, String name) {
        this.empID = empID;
        Name = name;
    }

    public BasePlusCommisonEmployee2(int empID, String name, double baseSalary, double totalSale) {
        this.empID = empID;
        Name = name;
